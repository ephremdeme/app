        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar" style="width:220px; height:100vh">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              <li class="nav-item" role="presentation"><a class="nav-link" href="/agent" style="color:#2056B3;"><i class="fa fa-dashboard"></i>&nbsp;Dashboard</a></li>
              <li class="nav-item" role="presentation"><a class="nav-link" href="/agent/ticket" style="color:#2056B3;"><i class="fa fa-ticket"></i>&nbsp;Tickets</a></li>
              <li class="nav-item" role="presentation"><a class="nav-link" href="/agent/comment" style="color:#2056B3;"><i class="fa fa-comments"></i>&nbsp;Comments</a></li>
              <li class="nav-item" role="presentation"><a class="nav-link" href="/movies/add" style="color:#2056B3;"><i class="fa fa-plus"></i>&nbsp;Add Movie</a></li>
              <li class="nav-item" role="presentation"><a class="nav-link" href="/logout" style="color:#2056B3;"><i class="icon ion-log-out"></i>&nbsp;Logout</a></li>
